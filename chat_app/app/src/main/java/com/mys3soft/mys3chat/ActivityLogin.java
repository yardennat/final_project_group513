...
/**
 * this  class is activity login to the app
 */
public class ActivityLogin extends AppCompatActivity {
    ...
    Button btn_Login;
    public static final String ENDPOINT = "https://chat-example-f10a5.firebaseio.com";
    ProgressDialog pd;
    String email;
            ...
            try {
                if (!jsonString.trim().equals("null")) {
                    ...
                    if (userObj.getString("Password").equals(pass)) {
                        ...
                        editor.putInt("score", userObj.getInt("score"));
                        editor.commit();
