...
//        final Firebase reference = new Firebase(StaticInfo.NotificationEndPoint + "/" + user.getEmail());
//        reference.addChildEventListener(
//                new ChildEventListener() {
//                    @Override
//                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
//                        if (LocalUserService.getLocalUserFromPreferences(getApplicationContext()).getEmail()!= null) {
...
//            if (frnd.getFirstName() != null) {
//                not.setContentTitle(frnd.getFirstName() + " " + frnd.getLastName());
//                i.putExtra("FriendFullName", frnd.getFirstName() + " " + frnd.getLastName());
//            } else {
